...
/**
 isActivityExists               : 判断 Activity 是否存在       ActivityUtils.isActivityExists(Config.PKG, SubActivityActivity.class.getName()
 startActivity                  : 启动 Activity                ActivityUtils.startActivity(SubActivityActivity.class);
 startActivities                : 启动多个 Activity            ActivityUtils.startActivities(this, intents, bundle);
 startHomeActivity              : 回到桌面                     ActivityUtils.startHomeActivity();
 getActivityList                : 获取 Activity 栈链表
 getLauncherActivity            : 获取启动项 Activity
 getTopActivity                 : 获取栈顶 Activity
 isActivityExistsInStack        : 判断 Activity 是否存在栈中    ActivityUtils.isActivityExistsInStack(CoreUtilActivity.class)
 finishActivity                 : 结束 Activity                 ActivityUtils.finishActivity(MainActivity.class);
 finishToActivity               : 结束到指定 Activity           ActivityUtils.finishToActivity(MainActivity.class, false, true);
 finishOtherActivities          : 结束所有其他类型的 Activity
 finishAllActivities            : 结束所有 Activity             ActivityUtils.finishAllActivities();
 finishAllActivitiesExceptNewest: 结束除最新之外的所有 Activity

 Config.PKG -> 指包名 eg: "com.blankj.androidutilcode"

 启动Activity
  1.根据类 启动Activity
    ActivityUtils.startActivity(SubActivityActivity.class);
    ActivityUtils.startActivity(SubActivityActivity.class, bundle);
    ActivityUtils.startActivity(SubActivityActivity.class, R.anim.fade_in_1000, R.anim.fade_out_1000);

  2.根据this和类 启动Activity
    ActivityUtils.startActivity(this, SubActivityActivity.class);
    ActivityUtils.startActivity(this, SubActivityActivity.class, bundle);
    ActivityUtils.startActivity(this, SubActivityActivity.class, R.anim.fade_in_1000, R.anim.fade_out_1000);

  3.根据类Name 启动Activity
    ActivityUtils.startActivity(this, this.getPackageName(), SubActivityActivity.class.getName());

  4.根据intent 启动Activity
...
public final class ActivityUtils {
    ...
    /**
     * ActivityUtils.getLauncherActivity(Config.PKG)
     * Return the name of launcher activity.
     *
     * @param pkg The name of the package.
     * @return the name of launcher activity
