 ...
 * 状态栏
 ...
 setStatusBarLightMode                : 设置状态栏是否为浅色模式    BarUtils.setStatusBarLightMode(this, true); true为灰色 false为白色
 ...
 setStatusBarColor                    : 设置状态栏颜色              BarUtils.setStatusBarColor(this, ContextCompat.getColor(UtilsApp.getInstance(), R.color.colorPrimary), mAlpha);
                                                                    BarUtils.addMarginTopEqualStatusBarHeight(mTvStatusAlpha);// 其实这个只需要调用一次即可
 setStatusBarAlpha                    : 设置状态栏透明度            BarUtils.setStatusBarAlpha(BarStatusAlphaActivity.this, mAlpha); //0-255
                                                                    BarUtils.addMarginTopEqualStatusBarHeight(mTvStatusAlpha);// 其实这个只需要调用一次即可
 ...
 1.在Fragment中修改状态栏的值
   ...
   2).在代码中
       ...
       BarUtils.setStatusBarColor(fakeStatusBar, ContextCompat.getColor(UtilsApp.getInstance(), R.color.colorPrimary), mAlpha)
