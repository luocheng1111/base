 ...
 * 亮度相关工具类
 *
 setWindowBrightness       : ( 建议用这个 )设置窗口亮度  BrightnessUtils.setWindowBrightness(getWindow(), progress);  0-255
 setBrightness             : 设置屏幕亮度  BrightnessUtils.setBrightness(progress); 0-255
 isAutoBrightnessEnabled   : 是否开启自动调节亮度  BrightnessUtils.isAutoBrightnessEnabled()
 setAutoBrightnessEnabled  : 设置是否开启自动调节亮度  BrightnessUtils.setAutoBrightnessEnabled(isChecked);
 */
