...
/**
 openWirelessSettings  : 打开网络设置界面      NetworkUtils.openWirelessSettings();
 isConnected           : 判断网络是否连接
 isAvailableByPing     : 判断网络是否可用
 getMobileDataEnabled  : 判断移动数据是否打开  NetworkUtils.setMobileDataEnabled(!NetworkUtils.getMobileDataEnabled());
 setMobileDataEnabled  : 打开或关闭移动数据    NetworkUtils.setWifiEnabled(!NetworkUtils.getWifiEnabled());
