...
import com.lc.base.util.utilconstants.PermissionConstants;
...
/**
 ...
 isGranted               : 判断权限是否被授予   PermissionUtils.isGranted(Manifest.permission.XXX)
 launchAppDetailsSettings: 打开应用具体设置     PermissionUtils.launchAppDetailsSettings();
 permission              : 设置请求权限
