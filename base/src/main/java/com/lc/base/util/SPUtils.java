...
/**
 getInstance: 获取 SP 实例    SPUtils.getInstance("demo")
 put        : SP 中写入数据    SPUtils.getInstance("demo").put("STRING", "string");
 getString  : SP 中读取 String SPUtils.getInstance("demo").getString("STRING");
 getInt     : SP 中读取 int
 getLong    : SP 中读取 long
